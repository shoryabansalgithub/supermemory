...
const Card = ({ featured, badge, title, price, cadence, blurb, features, cta }) => (
  <motion.div
    ...
    className={[
      ...
      featured ? "shadow-[0_24px_80px_rgba(0,0,0,0.35)] ring-1 ring-inset ring-white/10" : "shadow-[0_10px_35px_rgba(0,0,0,0.28)]",
    ].join(" ")}
  >
    ...
    <div className="pointer-events-none absolute inset-0 z-20">
      ...
      {featured && (
        <div className="absolute -inset-px rounded-[18px]" style={{ boxShadow: "0 0 0 1.5px rgba(45,107,255,0.35), 0 30px 140px rgba(45,107,255,0.2)" }} />
      )}
    </div>
    ...
    <div className="relative z-10 p-6 md:p-7 lg:p-8">
      {badge && (
        <div className={[
          ...
          featured ? "bg-[#2d6bff]/15 text-white border border-white/10" : "bg-white/[0.06] text-white/90 border border-white/10",
        ].join(" ")}>
          {badge}
        </div>
      )}
